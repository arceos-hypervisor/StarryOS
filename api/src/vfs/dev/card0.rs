...
pub const CARD0_SYSTEM_DEVICE_ID: DeviceId = DeviceId::new(254, 0);
...
impl DeviceOps for Card0 {
            ...
            _ => {
                ...
                if arg != 0 {
                    ...
                    if let Err(e) = (arg as *mut u32).vm_write(0u32) {
                        warn!("card0: ioctl vm_write failed: {:?}", e);
    ...
    fn as_any(&self) -> &dyn Any {
        info!("card0: as_any called - used for dynamic type checking");
        self
    }

    fn flags(&self) -> NodeFlags {
        info!("card0: flags called - returning NON_CACHEABLE flag");
